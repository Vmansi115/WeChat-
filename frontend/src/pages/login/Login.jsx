  ...
  return ( <div className="flex flex-col items-center justify-center min-w-96 mx-auto ">
    ...
    bg-opacity-0">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Link to ='/signup' className="text-sm hover:underline hover:text-blue-500 mt-2 inline-block text-gray-200">{"Don't"} have an account?</Link>
        <div >
  ...
  return ( <div className="flex flex-col items-center justify-center min-w-96 mx-auto ">
    ...
    bg-opacity-0">
      ...
      <form>
        ...
        <a href = '#' className="text-sm hover:underline hover:text-blue-500 mt-2 inline-block text-gray-200">{"Don't"} have an account?</a>
        <div >
